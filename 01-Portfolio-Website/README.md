...
## Objectives
The primary goal of the website is to create a credible digital presence that achieves the following:
- Clear personal positioning in the marketing analytics and consulting space.
...
---
### Links
- [Live Portfolio Website](https://www.ekrayneva.space/)
- [Main Repository](https://github.com/elenadkrayneva/Elena-Krayneva-Data-Portfolio)
